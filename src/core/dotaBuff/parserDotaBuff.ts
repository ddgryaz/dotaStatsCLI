...
import { IMostPopular } from "./types/IMostPopular.js";
import { IPlayerStats } from "./types/IPlayerStats.js";
import { IProviderResult } from "../../types/IProviderResult.js";
import { sleep } from "../../utils/sleep.js";
import { fetchData } from "./fetchData.js";
import { collectAllGames } from "./collectAllGames.js";
import { IAllArray } from "./types/IAllArray.js";
import { getTopCount } from "../getTopCount.js";
import { BaseError } from "../../errors/baseError.js";
import { BanError } from "../../errors/banError.js";
...
import { calcRecordsFromDotaBuff } from "./calcRecordsFromDotaBuff.js";
import { IRecords } from "../../types/IRecords.js";
import { sortByPopularityObjects } from "./sortByPopularityObjects.js";
...
export async function parserDotaBuff(
  ...
  for (let i: number = 0; i < TOTAL_TOP_HEROES; i++) {
    ...
    mostPopularHeroes.push({
      name: mostPopularHeroesWithoutStats[i].name,
  ...
  for (let i: number = 0; i < TOTAL_TOP_ITEMS; i++) {
    ...
    mostPopularItems.push({
      name: mostPopularItemsWithoutStats[i].name,
